...
@ModuleInfo(name = "No Interact", description = "Убирает взаимодействия с блоками", category = ModuleCategory.MISC)
public class NoInteract extends Module {
    public BooleanSetting allBlocks = new BooleanSetting("Все блоки", this);
    public MultiModeSetting ignoreInteract = new MultiModeSetting("Объекты", this, "Стойки для брони", "Сундуки", "Двери", "Кнопки", "Воронки", "Раздатчики", "Нотные блоки", "Верстаки", "Люки", "Печки", "Калитки", "Наковальни", "Рычаги").setVisible(() -> !allBlocks.isEnabled());
    ...
    private void addBlocksForInteractionType(Set<Integer> blocks, int interactionType, Integer... blockIds) {
        if (ignoreInteract.get(interactionType).isEnabled()) {
