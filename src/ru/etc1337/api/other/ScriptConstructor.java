...
public class ScriptConstructor {
    ...
    private final List<ScriptStep> scriptSteps = Lists.newArrayList();
    private final List<ScriptTickStep> scriptTickSteps = Lists.newArrayList();
    ...
    public ScriptConstructor addTickStep(int ticks, ScriptAction action) {
        return addTickStep(ticks, action, () -> true, 0);
    }

    public ScriptConstructor addTickStep(int ticks, ScriptAction action, BooleanSupplier condition) {
        return addTickStep(ticks, action, condition, 0);
    }

    public ScriptConstructor addTickStep(int ticks, ScriptAction action, int priority) {
        return addTickStep(ticks, action, () -> true, priority);
    }

    public ScriptConstructor addTickStep(int ticks, ScriptAction action, BooleanSupplier condition, int priority) {
    ...
    public ScriptConstructor setLoopStrategy(LoopStrategy loopStrategy) {
