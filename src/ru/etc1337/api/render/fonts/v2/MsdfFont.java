...
import net.minecraft.util.text.ColorFormatting;
...
public final class MsdfFont {
    ...
    public static class Builder {
        ...
        public Builder withData(String dataFile) {
            this.dataFile = new Resource(MSDF_PATH + dataFile);
            return this;
        }
      
        // should be png file
        public Builder withAtlas(String atlasFile) {
            this.atlasFile = new Resource(MSDF_PATH + atlasFile);
            return this;
        }
