...
public class Stencil implements QuickImports {
    ...
    public static void setupFBO(Framebuffer framebuffer) {
        ...
        EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT, EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, window.getWidth(), window.getHeight());
