...
package ru.etc1337.api.baritone.common.event;
...
import ru.etc1337.api.baritone.api.event.listener.IGameEventListener;
...
public final class GameEventHandler implements IEventBus, Helper {
    ...
    @Override
    public void onReceivePacket(BaritonePacketEvent event) {
        if (!BaritoneUtils.isEnabled()) {
            return;
        }
