...
import ru.etc1337.api.baritone.api.behavior.ILookBehavior;
import ru.etc1337.api.baritone.api.behavior.look.IAimProcessor;
import ru.etc1337.api.baritone.api.behavior.look.ITickableAimProcessor;
...
import ru.etc1337.api.baritone.common.behavior.look.ForkableRandom;
...
public final class LookBehavior extends Behavior implements ILookBehavior {
    ...
    @Override
    public void onSendPacket(BaritonePacketEvent event) {
...
//            return new Rotation(
//                    this.smoothRotation(prev.getYaw(), desiredYaw, (float) this.randomYawOffset),
//                    this.smoothRotation(prev.getPitch(), desiredPitch, (float) this.randomPitchOffset)
//            ).clamp();
        }
