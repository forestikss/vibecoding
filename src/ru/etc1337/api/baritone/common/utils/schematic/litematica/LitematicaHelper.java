...
package ru.etc1337.api.baritone.common.utils.schematic.litematica;
...
import ru.etc1337.api.baritone.litematica.Litematica;
import ru.etc1337.api.baritone.litematica.data.DataManager;
    ...
    public static Vector3i getCorrectedOrigin(LitematicaSchematic schematic, int i) {
        ...
        correctedOrigin = switch (mirror) {
            case FRONT_BACK, LEFT_RIGHT -> switch ((mirror.ordinal() * 2 + rotation.ordinal()) % 4) {
                case 1 -> new Vector3i(x + (sz - mz), y + my, z + (sx - mx));
                case 2 -> new Vector3i(x + mx, y + my, z + (sz - mz));
                case 3 -> new Vector3i(x + mz, y + my, z + mx);
                default -> new Vector3i(x + (sx - mx), y + my, z + mz);
            };
            default -> switch (rotation) {
                case CLOCKWISE_90 -> new Vector3i(x + (sz - mz), y + my, z + mx);
                case CLOCKWISE_180 -> new Vector3i(x + (sx - mx), y + my, z + (sz - mz));
                case COUNTERCLOCKWISE_90 -> new Vector3i(x + mz, y + my, z + (sx - mx));
                default -> new Vector3i(x + mx, y + my, z + mz);
            };
        };
