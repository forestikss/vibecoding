...
package ru.etc1337.api.baritone.common.command;
...
import ru.etc1337.api.baritone.api.command.argument.ICommandArgument;
import ru.etc1337.api.baritone.api.command.exception.CommandNotEnoughArgumentsException;
import ru.etc1337.api.baritone.api.command.exception.CommandNotFoundException;
import ru.etc1337.api.baritone.api.command.helpers.TabCompleteHelper;
import ru.etc1337.api.baritone.api.command.manager.ICommandManager;
import ru.etc1337.api.baritone.api.event.events.ChatEvent;
import ru.etc1337.api.baritone.api.event.events.TabCompleteEvent;
import ru.etc1337.api.baritone.api.utils.Helper;
import ru.etc1337.api.baritone.api.utils.SettingsUtil;
import ru.etc1337.api.baritone.common.Baritone;
import ru.etc1337.api.baritone.common.behavior.Behavior;
import ru.etc1337.api.baritone.common.command.argument.ArgConsumer;
import ru.etc1337.api.baritone.common.command.argument.CommandArguments;
import ru.etc1337.api.baritone.common.command.manager.CommandManager;
import ru.etc1337.api.baritone.common.utils.accessor.IGuiScreen;
...
import static ru.etc1337.api.baritone.api.command.IBaritoneChatControl.FORCE_COMMAND_PREFIX;
