...
import ru.etc1337.api.baritone.api.command.datatypes.RelativeFile;
...
import static ru.etc1337.api.baritone.api.utils.SettingsUtil.*;
...
public class SetCommand extends Command {
    ...
    public List<String> getLongDesc() {
        return Arrays.asList(
                ...
                "> set load [filename] - Load settings from another file in your minecraft/ru.etc1337.api.baritone"
        );
    }
}
