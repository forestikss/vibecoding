...
package ru.etc1337.api.baritone.common.pathing.movement.movements;
...
import ru.etc1337.api.baritone.api.utils.Rotation;
import ru.etc1337.api.baritone.api.utils.RotationUtils;
import ru.etc1337.api.baritone.api.utils.VecUtils;
...
import ru.etc1337.api.baritone.common.pathing.movement.MovementState;
    ...
    public MovementState updateState(MovementState state) {
        ...
        if (ladder) {
            ...
            if (dist > 0.17) {//why 0.17? because it seemed like a good number, that's why
                //[explanation added after ru.etc1337.api.baritone port lol] also because it needs to be less than 0.2 because of the 0.3 sneak limit
