...
package ru.etc1337.api.baritone.common.pathing.movement;
...
import ru.etc1337.api.baritone.common.pathing.movement.MovementState.MovementTarget;
import ru.etc1337.api.baritone.common.pathing.precompute.Ternary;
import ru.etc1337.api.baritone.common.utils.BlockStateInterface;
import ru.etc1337.api.baritone.common.utils.ToolSet;

import java.util.Optional;

import static ru.etc1337.api.baritone.common.pathing.movement.Movement.HORIZONTALS_BUT_ALSO_DOWN_____SO_EVERY_DIRECTION_EXCEPT_UP;
import static ru.etc1337.api.baritone.common.pathing.precompute.Ternary.*;
...
public interface MovementHelper extends ActionCosts, Helper {
    ...
    static Ternary canWalkThroughBlockState(BlockState state) {
        ...
        if (block instanceof TrapDoorBlock) {
            return state.get(TrapDoorBlock.OPEN) ? NO : state.get(TrapDoorBlock.HALF) == Half.TOP ? YES : NO;
        }
