...
package ru.etc1337.api.baritone.api.process;

import ru.etc1337.api.baritone.api.behavior.IPathingBehavior;
import ru.etc1337.api.baritone.api.event.events.PathEvent;

/**
 * A process that can control the PathingBehavior.
 * <p>
 * Differences between a ru.etc1337.api.baritone process and a behavior:
 * <ul>
 * <li>Only one ru.etc1337.api.baritone process can be active at a time</li>
