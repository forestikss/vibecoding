...
package ru.etc1337.api.baritone.api.event.listener;
...
public interface AbstractGameEventListener extends IGameEventListener {
    ...
    @Override
    default void onSendPacket(BaritonePacketEvent event) {
    }

    @Override
    default void onReceivePacket(BaritonePacketEvent event) {
    }
