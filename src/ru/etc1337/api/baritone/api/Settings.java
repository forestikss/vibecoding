...
import ru.etc1337.api.baritone.api.utils.NotificationHelper;
import ru.etc1337.api.baritone.api.utils.SettingsUtil;
import ru.etc1337.api.baritone.api.utils.TypeUtils;
import ru.etc1337.api.baritone.api.utils.gui.BaritoneToast;
...
public final class Settings {
    ...
    /**
     * Blocks that ru.etc1337.api.baritone will be allowed to break even with allowBreak set to false
     */
    ...
    /**
     * Disable ru.etc1337.api.baritone's auto-tool at runtime, but still assume that another mod will provide auto tool functionality
     * <p>
    ...
    /**
     * blocks that ru.etc1337.api.baritone shouldn't break, but can if it needs to.
     */
    ...
    /**
     * allows ru.etc1337.api.baritone to save bed waypoints when interacting with beds
     */
    public final Setting<Boolean> doBedWaypoints = new Setting<>(true);

    /**
     * allows ru.etc1337.api.baritone to save death waypoints
     */
    ...
    /**
     * This will only allow ru.etc1337.api.baritone to mine exposed ores, can be used to stop ore obfuscators on servers that use them.
     */
    ...
    /**
     * Build in map art mode, which makes ru.etc1337.api.baritone only care about the top block in each column
     */
