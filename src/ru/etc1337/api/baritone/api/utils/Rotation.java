...
package ru.etc1337.api.baritone.api.utils;
...
public class Rotation {
    ...
    public Rotation(float yaw, float pitch) {
        this.yaw = isValidAngle(yaw) ? yaw : 0.0F;
        this.pitch = isValidAngle(pitch) ? pitch : 0.0F;
    }

    private static boolean isValidAngle(float angle) {
        return !Float.isInfinite(angle) && !Float.isNaN(angle);
    }
