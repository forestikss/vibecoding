...
package ru.etc1337.api.baritone.api.utils.gui;
...
public class BaritoneToast implements IToast {
    ...
    public Visibility func_230444_a_(MatrixStack matrixStack, ToastGui toastGui, long delta) {
        ...
        if (this.subtitle == null) {
            toastGui.getMinecraft().fontRenderer.drawShadow(matrixStack, this.title, 18, 12, -11534256);
        } else {
            toastGui.getMinecraft().fontRenderer.drawShadow(matrixStack, this.title, 18, 7, -11534256);
            toastGui.getMinecraft().fontRenderer.drawShadow(matrixStack, this.subtitle, 18, 18, -16777216);
        }
    ...
    public static void addOrUpdate(ITextComponent title, ITextComponent subtitle) {
        addOrUpdate(Minecraft.getInstance().getToastGui(), title, subtitle, ru.etc1337.api.baritone.api.BaritoneAPI.getSettings().toastTimer.value);
    }
}
