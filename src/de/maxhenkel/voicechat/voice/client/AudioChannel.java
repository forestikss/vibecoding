...
public class AudioChannel extends Thread {
    ...
    private void writeToSpeaker(SoundPacket<?> packet, short[] monoData) {
        ...
        if (packet instanceof GroupSoundPacket) {
            ...
            @Nullable Entity entity = minecraft.world.getPlayerByUuid(soundPacket.getSender());
            if (entity == null) {
                ...
                entity = minecraft.world.getEntitiesInAABBexcluding((Entity) null, box, e -> e.getUniqueID().equals(soundPacket.getSender())).stream().findAny().orElse(null);
                if (entity == null) {
                    return;
                }
            }
