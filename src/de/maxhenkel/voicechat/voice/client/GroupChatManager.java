...
public class GroupChatManager {
    ...
    private static final ResourceLocation TALK_OUTLINE = new ResourceLocation("minecraft", "textures/icons/talk_outline.png");
    private static final ResourceLocation SPEAKER_OFF_ICON = new ResourceLocation("minecraft", "textures/icons/speaker_small_off.png");
