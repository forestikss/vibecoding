...
public class OnboardingManager {
    ...
    public static boolean isOnboarding() {
        return VoicechatClient.CLIENT_CONFIG != null && !VoicechatClient.CLIENT_CONFIG.onboardingFinished.get();
    }
    ...
    public static void onConnecting() {
        ...
        ChatUtils.sendModMessage(new TranslationTextComponent("message.voicechat.set_up",
                KeyEvents.KEY_VOICE_CHAT.getTranslatedKeyMessage().copyRaw().mergeStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)
        ));
    }
}
