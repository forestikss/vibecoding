...
public class VoiceActivationSlider extends DebouncedSlider implements MicTestButton.MicListener {
    ...
    private static final ResourceLocation SLIDER = new ResourceLocation("minecraft", "textures/gui/voice_activation_slider.png");
    ...
    protected void renderBg(MatrixStack poseStack, Minecraft minecraft, int i, int j) {
        Minecraft.getInstance().getTextureManager().bindTexture(SLIDER);
