      ...
      if (credentials.containsKey("userProperties")) {
         try {
            ...
            while(var3.hasNext()) {
               ...
               String propName = (String)propertyMap.get("name");  // Changed from 'name'
               String propValue = (String)propertyMap.get("value");  // Changed from 'name'
               String signature = (String)propertyMap.get("signature");
               if (signature == null) {
                  this.getModifiableUserProperties().put(propName, new Property(propName, propValue));
               } else {
                  this.getModifiableUserProperties().put(propName, new Property(propName, propValue, signature));
               }
            }
