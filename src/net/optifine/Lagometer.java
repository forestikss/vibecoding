    ...
    public static void showLagometer(MatrixStack matrixStackIn, int scaleFactor)
    {
        if (gameSettings != null)
        {
            if (gameSettings.ofLagometer || gameSettings.showLagometer)
            {
                ...
                mc.fontRenderer.drawShadow(matrixStackIn, s, 2.0F, (float)(j3 + 1), -8947849);
                mc.fontRenderer.drawShadow(matrixStackIn, s, 1.0F, (float)j3, -3881788);
                mc.fontRenderer.drawShadow(matrixStackIn, s1, 2.0F, (float)(i3 + 1), -8947849);
                mc.fontRenderer.drawShadow(matrixStackIn, s1, 1.0F, (float)i3, -3881788);
                GlStateManager.matrixMode(5889);
                ...
                mc.fontRenderer.drawShadow(matrixStackIn, " " + MemoryMonitor.getGcRateMb() + " MB/s", (float)k2, (float)l2, j2);
