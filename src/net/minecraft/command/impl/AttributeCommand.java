...
public class AttributeCommand
{
    ...
    public static void register(CommandDispatcher<CommandSource> p_241003_0_)
    {
        ...
        {
            return func_241010_a_(p_241022_0_.getSource(), EntityArgument.getEntity(p_241022_0_, "target"), ResourceLocationArgument.func_239094_d_(p_241022_0_, "attribute"), UUIDArgument.getUuid(p_241022_0_, "uuid"), StringArgumentType.getString(p_241022_0_, "name"), DoubleArgumentType.getDouble(p_241022_0_, "value"), AttributeModifier.Operation.ADDITION);
        })).then(Commands.literal("multiply").executes((p_241021_0_) ->
        {
            return func_241010_a_(p_241021_0_.getSource(), EntityArgument.getEntity(p_241021_0_, "target"), ResourceLocationArgument.func_239094_d_(p_241021_0_, "attribute"), UUIDArgument.getUuid(p_241021_0_, "uuid"), StringArgumentType.getString(p_241021_0_, "name"), DoubleArgumentType.getDouble(p_241021_0_, "value"), AttributeModifier.Operation.MULTIPLY_TOTAL);
        })).then(Commands.literal("multiply_base").executes((p_241020_0_) ->
        {
            return func_241010_a_(p_241020_0_.getSource(), EntityArgument.getEntity(p_241020_0_, "target"), ResourceLocationArgument.func_239094_d_(p_241020_0_, "attribute"), UUIDArgument.getUuid(p_241020_0_, "uuid"), StringArgumentType.getString(p_241020_0_, "name"), DoubleArgumentType.getDouble(p_241020_0_, "value"), AttributeModifier.Operation.MULTIPLY_BASE);
        })))))).then(Commands.literal("remove").then(Commands.argument("uuid", UUIDArgument.uuid()).executes((p_241018_0_) ->
        {
            return func_241008_a_(p_241018_0_.getSource(), EntityArgument.getEntity(p_241018_0_, "target"), ResourceLocationArgument.func_239094_d_(p_241018_0_, "attribute"), UUIDArgument.getUuid(p_241018_0_, "uuid"));
        }))).then(Commands.literal("value").then(Commands.literal("get").then(Commands.argument("uuid", UUIDArgument.uuid()).executes((p_241015_0_) ->
        {
            return func_241009_a_(p_241015_0_.getSource(), EntityArgument.getEntity(p_241015_0_, "target"), ResourceLocationArgument.func_239094_d_(p_241015_0_, "attribute"), UUIDArgument.getUuid(p_241015_0_, "uuid"), 1.0D);
        }).then(Commands.argument("scale", DoubleArgumentType.doubleArg()).executes((p_241004_0_) ->
        {
            return func_241009_a_(p_241004_0_.getSource(), EntityArgument.getEntity(p_241004_0_, "target"), ResourceLocationArgument.func_239094_d_(p_241004_0_, "attribute"), UUIDArgument.getUuid(p_241004_0_, "uuid"), DoubleArgumentType.getDouble(p_241004_0_, "scale"));
        })))))))));
    }
