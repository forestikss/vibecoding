...
public abstract class PlayerList
{
    ...
    {
        de.maxhenkel.voicechat.events.PlayerEvents.PLAYER_LOGGED_IN.invoker().accept(playerIn);
    ...
    {
        de.maxhenkel.voicechat.events.PlayerEvents.PLAYER_LOGGED_OUT.invoker().accept(playerIn);
