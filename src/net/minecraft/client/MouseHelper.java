...
public class MouseHelper
{
    ...
    public final MouseSmoother xSmoother = new MouseSmoother();
    ...
    private void mouseButtonCallback(long handle, int button, int action, int mods)
    {
        ...
        {
            new EventMouseClick(button, button, action == GLFW.GLFW_RELEASE).hook();
            ...
            if (!aboolean[0] && (this.minecraft.currentScreen == null || this.minecraft.currentScreen.passEvents) && this.minecraft.loadingGui == null)
            {
                ...
                {
                    if (this.minecraft.currentScreen == null) {
                        new EventInputKey(button, button, action == GLFW.GLFW_RELEASE).hook();
                    }
            ...
            if (this.minecraft.loadingGui == null)
            {
                ...
                else if (this.minecraft.player != null)
                {
                    ...
                    if (this.minecraft.player.isSpectator()) {
                        ...
                        if (beautifully == null || !beautifully.isEnabled() || !Config.zoomMode || !beautifully.mode.get("Улучшенный зум").isEnabled()) {
                            minecraft.player.inventory.changeCurrentItem(f1);
                        }
                    }
                }
            }
    ...
    public void updatePlayerLook()
    {
        ...
        if (this.isMouseGrabbed() && this.minecraft.isGameFocused())
        {
            ...
            {
                EventLook eventLook = new EventLook(d2, d3 * (double)i);
                eventLook.hook();
                if (!eventLook.isCancelled()) this.minecraft.player.rotateTowards(eventLook.getYaw(), eventLook.getPitch());
            }
        }
        else
        {
