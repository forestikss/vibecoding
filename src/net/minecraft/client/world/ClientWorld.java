...
import ru.etc1337.api.events.impl.game.EventEntitySpawn;
...
public class ClientWorld extends World
{
    ...
    {
        new EventEntitySpawn(entityToSpawn).hook();
    ...
    public void removeEntityFromWorld(int eid)
    {
        ...
        if (entity != null)
        {
            entity.remove();
            this.removeEntity(entity);
            new EventRemoveEntity(entity).hook();
        }
    }
    ...
    public Vector3d getSkyColor(BlockPos blockPosIn, float partialTicks)
    {
        ...
        EventWorldColor eventWorldColor = new EventWorldColor(f2, f3, f4);
