...
import ru.etc1337.api.capes.CapeHolder;
...
{
    StickSimulation stickSimulation;
    ...
    ResourceLocation CAPE_LOCATION = new ResourceLocation("dreamcore/images/cape/cape.png");
    ...
    public boolean hasCustomCape() {
        return this instanceof ClientPlayerEntity || Client.getInstance().getFriendManager().isFriend(this.getNameClear());
    }
