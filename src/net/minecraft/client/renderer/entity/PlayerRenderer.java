...
import ru.etc1337.api.capes.renderlayers.CustomCapeRenderLayer;
import ru.etc1337.api.interfaces.QuickImports;
import ru.etc1337.client.modules.impl.render.CustomModels;

public class PlayerRenderer extends LivingRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> implements QuickImports
{
    ...
    private void setModelVisibilities(AbstractClientPlayerEntity clientPlayer)
    {
        ...
        else
        {
            ...
            boolean isFriend = Client.getInstance().getFriendManager().isFriend(clientPlayer);
            boolean customModelsEnabled = Client.getInstance().getModuleManager().get(CustomModels.class).isEnabled();
            boolean applyToFriends = Client.getInstance().getModuleManager().get(CustomModels.class).friends.isEnabled();
    ...
    public ResourceLocation getEntityTexture(AbstractClientPlayerEntity entity)
    {
        ...
        boolean isFriend = Client.getInstance().getFriendManager().isFriend(entity);
        boolean shouldUseCustomModel = Client.getInstance().getModuleManager().get(CustomModels.class).isEnabled() &&
                (isLocalPlayer || (Client.getInstance().getModuleManager().get(CustomModels.class).friends.isEnabled() && isFriend));

        if (shouldUseCustomModel) {
            if (Client.getInstance().getModuleManager().get(CustomModels.class).mode.is("Rabbit")) {
                return new ResourceLocation("dreamcore/models/rabbit.png");
            } else if (Client.getInstance().getModuleManager().get(CustomModels.class).mode.is("Freddy Bear")) {
                return new ResourceLocation("dreamcore/models/freddy.png");
            } else if (Client.getInstance().getModuleManager().get(CustomModels.class).mode.is("Demon")) {
                return new ResourceLocation("dreamcore/models/reddemon.png");
            }
        }
