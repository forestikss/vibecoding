...
public class PlayerModel<T extends LivingEntity> extends BipedModel<T> {
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        ...
        boolean isFriend = Client.getInstance().getFriendManager().isFriend(this.entity);
        boolean shouldUseCustomModel = Client.getInstance().getModuleManager().get(CustomModels.class).isEnabled() && (isLocalPlayer || (Client.getInstance().getModuleManager().get(CustomModels.class).friends.isEnabled() && isFriend));
    ...
    public void translateHand(HandSide sideIn, MatrixStack matrixStackIn) {
        ...
        if (Client.getInstance().getModuleManager().get(CustomModels.class).isEnabled()) {
            if (this.smallArms) {
