...
import ru.etc1337.api.baritone.common.utils.accessor.IEntityRenderManager;
...
public class EntityRendererManager implements IEntityRenderManager
{
    ...
    public double renderPosX() {
        return this.info == null ? 0 : this.info.getProjectedView().x;
    }

    @Override
    public double renderPosY() {
        return this.info == null ? 0 : this.info.getProjectedView().y;
    }

    @Override
    public double renderPosZ() {
        return this.info == null ? 0 : this.info.getProjectedView().z;
    }
