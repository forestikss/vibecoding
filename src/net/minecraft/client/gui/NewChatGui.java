        ...
        if (!this.func_238496_i_())
        {
            ...
            if (k > 0)
            {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (k1 < 200 || flag)
                        {
                            ...
                            if (i2 > 3)
                            {
                                ...
                                {
                                    l = this.mc.fontRenderer.getStringWidth(chatline.getLineString()) - 2;
                                }
                                ...
                                if (beautifully.isEnabled() && beautifully.mode.get("Анимации в чате").isEnabled()) {
                                    chatline.getSlideAnimation().update(1.0F);
                                    p_238492_1_.translate((double) (-calculateChatboxWidth(this.mc.gameSettings.chatWidth)) + (double) calculateChatboxWidth(this.mc.gameSettings.chatWidth) * chatline.getSlideAnimation().getValue(), 0.0, 50.0);
                                }
                                ...
                                {
                                    this.mc.fontRenderer.drawShadow(p_238492_1_, chatline.getLineString(), 0.0F, (float)((int)(d6 + d4)), 16777215 + (i2 << 24));
                                }
                ...
                if (!this.field_238489_i_.isEmpty())
                {
                    ...
                    RenderSystem.enableBlend();
                    p_238492_1_.translate(0.0D, 0.0D, 50.0D);
                    this.mc.fontRenderer.drawShadow(p_238492_1_, new TranslationTextComponent("chat.queue", this.field_238489_i_.size()), 0.0F, 1.0F, 16777215 + (l2 << 24));
                    p_238492_1_.pop();
                    RenderSystem.disableAlphaTest();
                    RenderSystem.disableBlend();
                }
