...
public class SpectatorGui extends AbstractGui implements ISpectatorMenuRecipient
{
    ...
    private void func_238530_a_(MatrixStack p_238530_1_, int p_238530_2_, int p_238530_3_, float p_238530_4_, float p_238530_5_, ISpectatorMenuObject p_238530_6_)
    {
        ...
        if (p_238530_6_ != SpectatorMenu.EMPTY_SLOT)
        {
            ...
            {
                ITextComponent itextcomponent = this.mc.gameSettings.keyBindsHotbar[p_238530_2_].getTranslatedKeyMessage();
                this.mc.fontRenderer.drawShadow(p_238530_1_, itextcomponent, (float)(p_238530_3_ + 19 - 2 - this.mc.fontRenderer.getStringWidth(itextcomponent)), p_238530_4_ + 6.0F + 3.0F, 16777215 + (i << 24));
            }
        }
    }
    ...
    public void func_238527_a_(MatrixStack p_238527_1_)
    {
        ...
        if (i > 3 && this.menu != null)
        {
            ...
            {
                int j = (this.mc.getMainWindow().getScaledWidth() - this.mc.fontRenderer.getStringWidth(itextcomponent)) / 2;
                int k = this.mc.getMainWindow().getScaledHeight() - 35;
                RenderSystem.pushMatrix();
                RenderSystem.enableBlend();
                RenderSystem.defaultBlendFunc();
                this.mc.fontRenderer.drawShadow(p_238527_1_, itextcomponent, (float)j, (float)k, 16777215 + (i << 24));
                RenderSystem.disableBlend();
                RenderSystem.popMatrix();
            }
        }
