...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry>
{
    ...
    public static class LanDetectedEntry extends ServerSelectionList.Entry
    {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
        {
            ...
            this.mc.fontRenderer.drawShadow(p_230432_1_, this.serverData.getServerMotd(), (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 12), 8421504);
            ...
            {
                this.mc.fontRenderer.drawShadow(p_230432_1_, this.serverData.getServerIpPort(), (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 12 + 11), 3158064);
            }
        }
    ...
    public static class LanScanEntry extends ServerSelectionList.Entry
    {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
        {
            ...
            this.mc.fontRenderer.func_243248_b(p_230432_1_, ServerSelectionList.field_243365_r, (float)(this.mc.currentScreen.width / 2 - this.mc.fontRenderer.getStringWidth(ServerSelectionList.field_243365_r) / 2), (float)i, 16777215);
            String s;
            ...
            this.mc.fontRenderer.drawShadow(p_230432_1_, s, (float)(this.mc.currentScreen.width / 2 - this.mc.fontRenderer.getStringWidth(s) / 2), (float)(i + 9), 8421504);
        }
    }
    ...
    public class NormalEntry extends ServerSelectionList.Entry
    {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
        {
            ...
            this.mc.fontRenderer.drawShadow(p_230432_1_, this.server.serverName, (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 1), 16777215);
            ...
            int j = this.mc.fontRenderer.getStringWidth(itextcomponent1);
