...
public class DemoScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        this.field_243286_b = IBidiRenderer.func_243260_a(this.font, new TranslationTextComponent("demo.help.movementShort", gamesettings.keyBindForward.getTranslatedKeyMessage(), gamesettings.keyBindLeft.getTranslatedKeyMessage(), gamesettings.keyBindBack.getTranslatedKeyMessage(), gamesettings.keyBindRight.getTranslatedKeyMessage()), new TranslationTextComponent("demo.help.movementMouse"), new TranslationTextComponent("demo.help.jump", gamesettings.keyBindJump.getTranslatedKeyMessage()), new TranslationTextComponent("demo.help.inventory", gamesettings.keyBindInventory.getTranslatedKeyMessage()));
