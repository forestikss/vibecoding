...
public class MerchantScreen extends ContainerScreen<MerchantContainer>
{
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y)
    {
        ...
        if (i > 0 && i <= 5 && this.container.func_217042_i())
        {
            ...
            int j = this.font.getStringWidth(itextcomponent);
            int k = 49 + this.xSize / 2 - j / 2;
            this.font.func_243248_b(matrixStack, itextcomponent, (float)k, 6.0F, 4210752);
        }
        else
        {
            this.font.func_243248_b(matrixStack, this.title, (float)(49 + this.xSize / 2 - this.font.getStringWidth(this.title) / 2), 6.0F, 4210752);
        }

        this.font.func_243248_b(matrixStack, this.playerInventory.getDisplayName(), (float)this.playerInventoryTitleX, (float)this.playerInventoryTitleY, 4210752);
        int l = this.font.getStringWidth(field_243351_B);
