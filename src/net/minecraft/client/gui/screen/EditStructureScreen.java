...
public class EditStructureScreen extends Screen
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (structuremode == StructureMode.LOAD || structuremode == StructureMode.SAVE)
        {
            ...
            drawString(matrixStack, this.font, field_243360_r, this.width / 2 + 154 - this.font.getStringWidth(field_243360_r), 150, 10526880);
        }
        ...
        if (structuremode == StructureMode.SAVE)
        {
            ...
            drawString(matrixStack, this.font, field_243361_s, this.width / 2 + 154 - this.font.getStringWidth(field_243361_s), 110, 10526880);
            drawString(matrixStack, this.font, field_243362_t, this.width / 2 + 154 - this.font.getStringWidth(field_243362_t), 70, 10526880);
        }
        ...
        if (structuremode == StructureMode.LOAD)
        {
            ...
            drawString(matrixStack, this.font, field_243363_u, this.width / 2 + 154 - this.font.getStringWidth(field_243363_u), 70, 10526880);
        }
