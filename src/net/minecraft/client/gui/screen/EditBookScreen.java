...
public class EditBookScreen extends Screen
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.bookGettingSigned)
        {
            ...
            int k = this.font.getStringWidth(field_243340_a);
            ...
            int i1 = this.font.getStringWidth(this.field_243339_L);
        ...
        {
            int j1 = this.font.getStringWidth(this.field_243338_K);
    ...
    private void func_238756_a_(MatrixStack p_238756_1_, EditBookScreen.Point p_238756_2_, boolean p_238756_3_)
    {
        if (this.updateCount / 6 % 2 == 0)
        {
            ...
            {
                this.font.drawShadow(p_238756_1_, "_", (float)p_238756_2_.x, (float)p_238756_2_.y, 0);
            }
        }
    }
