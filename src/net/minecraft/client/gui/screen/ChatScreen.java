...
public class ChatScreen extends Screen implements QuickImports
{
    ...
    protected void init()
    {
        this.addButton(button = new Button(window.getScaledWidth() - 152, window.getScaledHeight() - 35, 150, 20, new StringTextComponent("Hide information: " + hide), (button) ->
        {
            hide = !hide;
        }));
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        for (Draggable draggable : Client.getInstance().getDraggableManager().draggables.values()) {
    ...
    {
        if (button != null) {
            button.setMessage(new StringTextComponent("Hide information: " + hide));
        }
