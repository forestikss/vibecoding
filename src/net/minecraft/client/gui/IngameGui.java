...
public class IngameGui extends AbstractGui
{
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks)
    {
        ...
        de.maxhenkel.voicechat.events.RenderEvents.RENDER_HUD.invoker().accept(matrixStack);
        ...
        if (!this.mc.gameSettings.hideGUI)
        {
            if (this.overlayMessage != null && this.overlayMessageTime > 0)
            {
                ...
                if (i1 > 8)
                {
                    ...
                    int l = fontrenderer.getStringWidth(this.overlayMessage);
            ...
            if (this.displayedTitle != null && this.titlesTimer > 0)
            {
                ...
                if (j1 > 8)
                {
                    ...
                    fontrenderer.drawShadow(matrixStack, this.displayedTitle, (float)(-i2 / 2), -10.0F, 16777215 | l1);
                    RenderSystem.popMatrix();
                    ...
                    if (this.displayedSubTitle != null)
                    {
                        ...
                        int k2 = fontrenderer.getStringWidth(this.displayedSubTitle);
                        this.func_238448_a_(matrixStack, fontrenderer, 5, k2, 16777215 | l1);
                        fontrenderer.drawShadow(matrixStack, this.displayedSubTitle, (float)(-k2 / 2), 5.0F, 16777215 | l1);
                        RenderSystem.popMatrix();
                    }
        ...
        if (mc.gameSettings.hideGUI || mc.gameSettings.showDebugInfo) return;
        new EventRender2D(matrixStack, partialTicks).hookRender();
    }
        ...
        if (interfaceModule.isEnabled()) {
            for (Setting setting : interfaceModule.getSettings()) {
                if (setting instanceof MultiModeSetting multiSetting) {
                    BooleanSetting elementSetting = multiSetting.get("potions");
    ...
    public void func_238454_b_(MatrixStack p_238454_1_, int p_238454_2_)
    {
        ...
        if (this.mc.player.experienceLevel > 0)
        {
            ...
            this.getFontRenderer().drawShadow(p_238454_1_, s, (float)(k1 + 1), (float)i1, 0);
            this.getFontRenderer().drawShadow(p_238454_1_, s, (float)(k1 - 1), (float)i1, 0);
            this.getFontRenderer().drawShadow(p_238454_1_, s, (float)k1, (float)(i1 + 1), 0);
            this.getFontRenderer().drawShadow(p_238454_1_, s, (float)k1, (float)(i1 - 1), 0);
            this.getFontRenderer().drawShadow(p_238454_1_, s, (float)k1, (float)i1, j1);
            this.mc.getProfiler().endSection();
        }
    }
    ...
    public void func_238453_b_(MatrixStack p_238453_1_)
    {
        ...
        if (this.remainingHighlightTicks > 0 && !this.highlightingItemStack.isEmpty())
        {
            ...
            int i = this.getFontRenderer().getStringWidth(itextcomponent);
            ...
            if (l > 0)
            {
                ...
                {
                    i = (this.scaledWidth - fontrenderer.getStringWidth(itextcomponent)) / 2;
                    fontrenderer.func_238422_b_(p_238453_1_, itextcomponent.getVisualOrderText(), (float)j, (float)k, 16777215 + (l << 24));
                }
                else
                {
                    this.getFontRenderer().drawShadow(p_238453_1_, itextcomponent, (float)j, (float)k, 16777215 + (l << 24));
                }
    ...
    public void func_238455_c_(MatrixStack p_238455_1_)
    {
        ...
        int i = this.getFontRenderer().getStringWidth(itextcomponent);
        this.getFontRenderer().drawShadow(p_238455_1_, itextcomponent, (float)(this.scaledWidth - i - 10), 5.0F, 16777215);
        this.mc.getProfiler().endSection();
    }
    ...
    private void func_238447_a_(MatrixStack p_238447_1_, ScoreObjective p_238447_2_)
    {
        ...
        if (noRender.isEnabled() && noRender.remove.get("Таблицу").isEnabled()) {
            return;
        }
        ...
        for (Score score : collection)
        {
            ...
            j = Math.max(j, this.getFontRenderer().getStringWidth(itextcomponent1) + k + this.getFontRenderer().getStringWidth(Integer.toString(score.getScorePoints())));
        }
        ...
        for (Pair<Score, ITextComponent> pair : list1)
        {
            ...
            this.getFontRenderer().drawShadow(p_238447_1_, s, (float)(l1 - this.getFontRenderer().getStringWidth(s)), (float)k1, -1);
    ...
    {
        NoRender noRender = Client.getInstance().getModuleManager().get(NoRender.class);
        if (noRender.isEnabled() && noRender.remove.get("Тайтлы").isEnabled()) {
            return;
        }
