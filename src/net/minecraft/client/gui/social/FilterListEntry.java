...
public class FilterListEntry extends AbstractOptionList.Entry<FilterListEntry>
{
    ...
    public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
    {
        ...
        this.field_244620_e.fontRenderer.drawShadow(p_230432_1_, this.field_244623_h, (float)k, (float)l, field_244619_d);
        ...
        if (this.field_244626_k != null && this.field_244627_l != null)
        {
            ...
            this.field_244626_k.y = p_230432_3_ + (p_230432_6_ - this.field_244626_k.getHeight()) / 2;
            ...
            this.field_244627_l.y = p_230432_3_ + (p_230432_6_ - this.field_244627_l.getHeight()) / 2;
    ...
    private void func_244635_a(boolean p_244635_1_, ITextComponent p_244635_2_)
    {
        ...
        //sosal.saysosal(p_244635_2_.getString());
    }
