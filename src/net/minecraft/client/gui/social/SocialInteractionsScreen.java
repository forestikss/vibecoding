...
public class SocialInteractionsScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        int l = this.font.getStringWidth(field_244766_x) + 40;
    ...
    private void func_244682_a(SocialInteractionsScreen.Mode p_244682_1_)
    {
        ...
        {
            //sosal.saysosal(field_244764_u.getString());
        }
        else if (collection.isEmpty())
        {
            if (p_244682_1_ == SocialInteractionsScreen.Mode.HIDDEN)
            {
                //sosal.saysosal(field_244672_s.getString());
            }
            else if (p_244682_1_ == SocialInteractionsScreen.Mode.BLOCKED)
            {
                //sosal.saysosal(field_244765_w.getString());
            }
        }
    }
