...
public class DebugOverlayGui extends AbstractGui
{
    ...
    protected void renderDebugInfoLeft(MatrixStack p_230024_1_)
    {
        ...
        if (list == null || System.currentTimeMillis() > this.updateInfoLeftTimeMs)
        {
            ...
            list.add(String.format("[%s-via] -> %s (%s)", "Stradix", ViaLoadingBase.getInstance().getTargetVersion().getName(), ViaLoadingBase.getInstance().getTargetVersion().getVersion()));
    ...
    private void func_238509_a_(MatrixStack p_238509_1_, FrameTimer p_238509_2_, int p_238509_3_, int p_238509_4_, boolean p_238509_5_)
    {
        if (!p_238509_5_)
        {
            ...
            if (p_238509_5_)
            {
                ...
                this.fontRenderer.drawShadow(p_238509_1_, "60 FPS", (float)(p_238509_3_ + 2), (float)(l4 - 30 + 2), 14737632);
                ...
                this.fontRenderer.drawShadow(p_238509_1_, "30 FPS", (float)(p_238509_3_ + 2), (float)(l4 - 60 + 2), 14737632);
                this.hLine(p_238509_1_, p_238509_3_, p_238509_3_ + j1 - 1, l4 - 60, -1);
            }
            else
            {
                fill(p_238509_1_, p_238509_3_ + 1, l4 - 60 + 1, p_238509_3_ + 14, l4 - 60 + 10, -1873784752);
                this.fontRenderer.drawShadow(p_238509_1_, "20 TPS", (float)(p_238509_3_ + 2), (float)(l4 - 60 + 2), 14737632);
                this.hLine(p_238509_1_, p_238509_3_, p_238509_3_ + j1 - 1, l4 - 60, -1);
            }
