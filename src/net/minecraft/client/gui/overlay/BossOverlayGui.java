...
public class BossOverlayGui extends AbstractGui
{
    ...
    public void func_238484_a_(MatrixStack p_238484_1_)
    {
        ...
        if (noRender.isEnabled() && noRender.remove.get("Линию босса").isEnabled()) {
            return;
        }
        if (!this.mapBossInfos.isEmpty())
        {
            ...
            for (ClientBossInfo clientbossinfo : this.mapBossInfos.values())
            {
                ...
                if (flag)
                {
                    ...
                    int i1 = this.client.fontRenderer.getStringWidth(itextcomponent);
                    int j1 = i / 2 - i1 / 2;
                    int k1 = j - 9;
                    int l1 = 16777215;
                    ...
                    this.client.fontRenderer.drawShadow(p_238484_1_, itextcomponent, (float)j1, (float)k1, l1);
                }
