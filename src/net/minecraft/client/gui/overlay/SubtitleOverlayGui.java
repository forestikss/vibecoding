    ...
    public void render(MatrixStack p_195620_1_)
    {
        ...
        if (this.enabled && !this.subtitles.isEmpty())
        {
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    j = Math.max(j, this.client.fontRenderer.getStringWidth(subtitleoverlaygui$subtitle.func_238526_a_()));
                }
            }
            ...
            for (SubtitleOverlayGui.Subtitle subtitleoverlaygui$subtitle1 : this.subtitles)
            {
                ...
                int j1 = i1 / 2;
                float f = 1.0F;
                int k1 = this.client.fontRenderer.getStringWidth(itextcomponent);
                ...
                if (!flag)
                {
                    if (d0 > 0.0D)
                    {
                        this.client.fontRenderer.drawShadow(p_195620_1_, ">", (float)(l - this.client.fontRenderer.getStringWidth(">")), (float)(-j1), i2 + -16777216);
                    }
                    else if (d0 < 0.0D)
                    {
                        this.client.fontRenderer.drawShadow(p_195620_1_, "<", (float)(-l), (float)(-j1), i2 + -16777216);
                    }
                }
