...
public abstract class AbstractGui
{
    ...
    public static void drawCenteredString(MatrixStack matrixStack, FontRenderer fontRenderer, ITextComponent font, int text, int x, int y)
    {
        ...
        fontRenderer.drawShadow(matrixStack, ireorderingprocessor, (float)(text - fontRenderer.getStringWidth(ireorderingprocessor) / 2), (float)x, y);
    }
    ...
    {
        fontRenderer.drawShadow(matrixStack, font, (float)text, (float)x, y);
    }
