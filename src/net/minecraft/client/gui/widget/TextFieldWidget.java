...
public class TextFieldWidget extends Widget implements IRenderable, IGuiEventListener, QuickImports
{
    ...
    String[] words = new String[]{"reg", "register", "l", "login", "call", "tpa", "warp", "home"};
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        if (this.getVisible())
        {
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = this.fontRenderer.drawShadow(matrixStack, this.textFormatter.apply(s1, this.lineScrollOffset), (float)l, (float)i1, i2);
                ...
                if (contains && ChatScreen.hide) {
                    Round.draw(matrixStack, new Rect(2, window.getScaledHeight() - 14, this.fontRenderer.getStringWidth(s1) + 3, 12), 0, FixColor.BLACK);
                }
            }
            ...
            {
                this.fontRenderer.drawShadow(matrixStack, this.textFormatter.apply(s.substring(j), this.cursorPosition), (float)j1, (float)i1, i2);
            }
