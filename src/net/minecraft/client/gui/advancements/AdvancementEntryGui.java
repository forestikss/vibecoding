...
public class AdvancementEntryGui extends AbstractGui
{
    ...
    public void drawAdvancementHover(MatrixStack matrixStack, int x, int y, float fade, int width, int height)
    {
        ...
        if (flag)
        {
            this.minecraft.fontRenderer.drawShadow(matrixStack, this.title, (float)(i1 + 5), (float)(y + this.y + 9), -1);
        ...
        {
            this.minecraft.fontRenderer.drawShadow(matrixStack, this.title, (float)(x + this.x + 32), (float)(y + this.y + 9), -1);
