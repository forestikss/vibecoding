...
public class FontRenderer
{
    ...
    public int drawShadow(MatrixStack matrixStack, String text, float x, float y, int color)
    {
        RenderSystem.enableAlphaTest();
    ...
    {
        RenderSystem.enableAlphaTest();
        return this.func_238415_a_(p_243246_2_.getVisualOrderText(), p_243246_3_, p_243246_4_, p_243246_5_, p_243246_1_.getLast().getMatrix(), true);
    }
    ...
    {
        RenderSystem.enableAlphaTest();
        return this.func_238415_a_(p_243248_2_.getVisualOrderText(), p_243248_3_, p_243248_4_, p_243248_5_, p_243248_1_.getLast().getMatrix(), false);
    }
    ...
    {
        return this.func_238416_a_(p_243247_1_.getVisualOrderText(), p_243247_2_, p_243247_3_, p_243247_4_, p_243247_5_, p_243247_6_, p_243247_7_, p_243247_8_, p_243247_9_, p_243247_10_);
    }
    ...
    public int getStringWidth(ITextProperties properties)
    {
