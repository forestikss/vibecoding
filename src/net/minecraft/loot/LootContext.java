        ...
        public LootContext build(LootParameterSet parameterSet)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    return new LootContext(random, this.luck, this.world,
                            BaritoneUtils.getLootTableManager(minecraftserver)::getLootTableFromLocation,
                            BaritoneUtils.getLootPredicateManager(minecraftserver)::func_227517_a_,
                            this.lootParameters, this.field_216026_c);
        /*            return new LootContext(random, this.luck, this.world,
                            minecraftserver.getLootTableManager()::getLootTableFromLocation,
                            minecraftserver.func_229736_aP_()::func_227517_a_,
                            this.lootParameters, this.field_216026_c);*/
                }
            }
        }
